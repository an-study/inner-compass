    ...
    <section className="bg-gradient-to-b from-white to-[#FFF9F0] py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="text-4xl md:text-5xl mt-4 mb-6 text-[#2D3748] font-bold inline-flex items-center justify-center gap-3">
        ...
        <div className="mt-16 bg-gradient-to-r from-[#FFE9CC] to-[#FFD9A8] rounded-3xl p-8 md:p-12 text-center">
          <p className="text-2xl md:text-3xl font-bold text-[#2D3748] mb-4">
            {t.encouragement1}
            <br />{t.encouragement2}
          </p>
          <p className="text-lg text-gray-700 inline-flex items-center justify-center gap-2">
