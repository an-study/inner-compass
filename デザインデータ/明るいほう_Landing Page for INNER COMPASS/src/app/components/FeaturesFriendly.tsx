    ...
    <section className="bg-gradient-to-b from-[#FFF9F0] to-white py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="text-4xl md:text-5xl mt-4 mb-6 text-[#2D3748] font-bold" style={{ fontFamily: 'Nunito, sans-serif' }}>
          ...
          {t.features.map((feature, index) => {
            ...
            return (
              <div key={index} className="bg-white p-8 rounded-3xl shadow-md hover:shadow-2xl transition-all duration-300 border-2 border-gray-100 hover:border-[#FFB347]">
                ...
                {/* Title */}
                <h3 className="text-2xl font-bold mb-4 text-[#2D3748]" style={{ fontFamily: 'Nunito, sans-serif' }}>
                  {feature.title}
                </h3>
              
                {/* Description */}
                <p className="text-gray-600 leading-relaxed mb-6" style={{ fontFamily: 'Nunito, sans-serif' }}>
                  {feature.description}
                </p>
                ...
                <ul className="space-y-3 mb-6">
                  {feature.highlights.map((highlight, idx) => (
                    <li key={idx} className="flex items-center gap-3 text-sm text-gray-700">
                      ...
                      <span className="font-medium" style={{ fontFamily: 'Nunito, sans-serif' }}>{highlight}</span>
                    </li>
                  ))}
                </ul>
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <div className="relative rounded-3xl overflow-hidden border-4 border-white shadow-2xl bg-white">
              ...
              <div className="relative aspect-[16/10] overflow-hidden">
                <ImageWithFallback 
                  src={featureImages[currentSlide]}
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent p-6 md:p-8">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-white" style={{ fontFamily: 'Nunito, sans-serif' }}>
                    {t.features[currentSlide].title}
                  </h3>
                </div>
                <p className="text-white/90 text-sm md:text-base" style={{ fontFamily: 'Nunito, sans-serif' }}>
                  {t.features[currentSlide].description}
                </p>
              </div>
          ...
          {t.tips.map((tip, index) => {
            ...
            return (
              <div key={index} className="bg-gradient-to-br from-[#FFE9CC] to-[#FFD9A8] p-6 rounded-2xl">
                ...
                <h4 className="font-bold text-lg mb-2 text-[#2D3748]" style={{ fontFamily: 'Nunito, sans-serif' }}>{tip.title}</h4>
                <p className="text-sm text-gray-700" style={{ fontFamily: 'Nunito, sans-serif' }}>
                  {tip.description}
                </p>
              </div>
            );
