    ...
    <section id="cta-section" className="bg-gradient-to-b from-white to-[#FFF9F0] py-24 md:py-32">
      <div className="max-w-5xl mx-auto px-6 md:px-12">
        ...
        <div className="bg-gradient-to-br from-[#FFE9CC] via-[#FFD9A8] to-[#FFB347] rounded-3xl p-12 md:p-16 text-center shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="inline-flex items-center gap-2 bg-white text-[#FF9A76] px-6 py-3 rounded-full mb-8 shadow-lg font-bold">
              ...
              <span className="text-base" style={{ fontFamily: 'Nunito, sans-serif' }}>{t.badge}</span>
            </div>
            
            {/* Heading */}
            <h2 className="text-4xl md:text-6xl font-bold mb-6 text-[#2D3748]" style={{ fontFamily: 'Nunito, sans-serif' }}>
              {t.title1}
              <br />
            ...
            <div className="mb-8">
              <div className="flex items-center justify-center gap-3 mb-2">
                <div className="text-6xl font-bold text-[#FF9A76]" style={{ fontFamily: 'Nunito, sans-serif' }}>
                  {t.currentPrice}
                </div>
                <span className="text-xl text-[#2D3748]" style={{ fontFamily: 'Nunito, sans-serif' }}>{t.taxIncluded}</span>
              </div>
            </div>
        ...
        <div className="mt-12 text-center space-y-4">
          <p className="text-gray-500 text-sm inline-flex items-center justify-center gap-2" style={{ fontFamily: 'Nunito, sans-serif' }}>
