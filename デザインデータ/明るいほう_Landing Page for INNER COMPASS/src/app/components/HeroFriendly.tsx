        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="inline-block">
              <span className="bg-[#FF9A76] text-white px-4 py-2 rounded-full text-sm font-semibold inline-flex items-center gap-2" style={{ fontFamily: 'Nunito, sans-serif' }}>
                <Sparkles className="w-4 h-4" />
                {t.badge}
              </span>
            </div>
            
            <h1 className="text-5xl md:text-7xl leading-tight font-bold text-[#2D3748]" style={{ fontFamily: 'Nunito, sans-serif' }}>
              {t.title1}<br />
              <span className="text-[#FF9A76]">{t.title2}</span>
            </h1>
            
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed" style={{ fontFamily: 'Nunito, sans-serif' }}>
              {t.description}
              <br />{t.description2}
            </p>
            ...
            <div className="flex items-center gap-6 pt-4">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 text-center shadow-md">
                <div className="text-3xl font-bold text-[#FF9A76]" style={{ fontFamily: 'Nunito, sans-serif' }}>{t.stat1}</div>
